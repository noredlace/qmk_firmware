...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_0, KC_0, KC_DOT, FUNCTION,  KC_LGUI, KC_LALT, LOWER,   LT(_LOWER, KC_SPC),    LT(_RAISE, KC_ENT),   RAISE,    KC_RALT, FUNCTION, KC_LEFT, KC_DOWN, KC_RGHT
   ),
   ...
   KC_4, KC_5, KC_6,   KC_CTLTB, KC_F1,   KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_6,  KC_5,   KC_4,    KC_SCLN,  KC_QUOT, KC_DEL, KC_END,
