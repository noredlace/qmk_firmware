...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_4, KC_5, KC_6,    KC_CTLTB,  KC_A,    KC_S,    KC_D,   KC_F,  KC_G,   KC_H,  KC_J,  KC_K,     KC_L,    KC_SCLN,  KC_QUOT, KC_DEL, KC_Q,//KC_END,
   ...
   KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_A,
   QWERTY,  GAMING,  KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  ...
  [_GAMING] = KEYMAP(
   ...
   KC_1, KC_2, KC_3,    KC_LSFT,   KC_Z,    KC_X,    KC_C,   KC_V,  KC_B,   KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT, KC_UP,
   KC_DOT, KC_0, KC_P0, FUNCTION,  KC_LGUI, KC_LALT, LOWER,    KC_SPC,          KC_ENT,   RAISE,    KC_RALT, FUNCTION, KC_LEFT, KC_DOWN, KC_RGHT
)
