...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   KC_0, KC_0, KC_DOT, FUNCTION,  KC_LGUI, KC_LALT, LOWER,    KC_SPC,        KC_ENT,     RAISE,    KC_RALT, FUNCTION, KC_LEFT, KC_DOWN, KC_RGHT
   ),
   ...
   KC_0, KC_0, KC_DOT, KC_LCTL,   KC_LGUI, KC_LALT, LOWER,    KC_SPC,        KC_ENT,     RAISE,    KC_RALT, KC_TRNS,  KC_LEFT, KC_DOWN, KC_RGHT
	...
	[_LOWER] = KEYMAP(
	 KC_7, KC_8, KC_9,   KC_ESC,  KC_1 ,   KC_2,    KC_3,   KC_4,   KC_5,   KC_6,   KC_7,  KC_8,     KC_9,    KC_0,     KC_BSPC, KC_INS, KC_HOME,
   KC_4, KC_5, KC_6,   KC_CTLTB,  KC_F1,   KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_J,  KC_K,     KC_L,    KC_SCLN,  KC_QUOT, KC_DEL, KC_END,
   KC_1, KC_2, KC_3,   KC_LSFT, KC_F7,   KC_F8,   KC_F9,  KC_F10, KC_F11, KC_F12, KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT, KC_UP,
   KC_0, KC_0, KC_DOT, KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS,   KC_SPC,        KC_ENT,    RAISE,    KC_RALT, FUNCTION, KC_LEFT, KC_DOWN, KC_RGHT
),

	[_RAISE] = KEYMAP(
	 KC_7, KC_8, KC_9,   KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,   KC_PERC,   KC_CIRC,  KC_AMPR,  KC_ASTR,   KC_LPRN,   KC_RPRN,  KC_BSPC,  KC_INS,  KC_HOME,
   KC_4, KC_5, KC_6,   KC_CTLTB,  KC_TRNS, KC_MINS, KC_EQL,  KC_LCBR,  KC_RCBR,   KC_LEFT,  KC_DOWN,  KC_UP,     KC_RIGHT,  KC_PIPE,  KC_GRV,   KC_DEL,  KC_END,
