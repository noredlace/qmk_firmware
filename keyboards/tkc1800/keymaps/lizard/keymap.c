...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT(
    ...
    KC_LOWE, KC_LALT, XXXXXXX,                   KC_SPC,                             XXXXXXX, KC_RALT, KC_MOFU,      KC_LEFT, KC_DOWN, KC_RGHT,     KC_P0,   KC_PDOT, KC_PENT  \
  ),
   ...
   */
  [FUNCTION] = LAYOUT(
       KC_F, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, \
